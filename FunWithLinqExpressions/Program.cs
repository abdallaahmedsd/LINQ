...
static void ListProductNames(ProductInfo[] products)
{
	...
	var names = from product in products
				select product.Name;
...
static void GetOverstock(ProductInfo[] products)
{
	...
	var overstock = from product in products
...
static void PagingWithChunks(ProductInfo[] products)
{
	...
	IEnumerable<ProductInfo[]> chunks = products.Chunk(size: 4);
...
static void DisplayUnion()
{
	...
	.Union(from c2 in yourCars select c2).Order();
